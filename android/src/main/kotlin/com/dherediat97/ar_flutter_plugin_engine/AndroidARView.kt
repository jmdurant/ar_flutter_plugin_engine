...
import com.dherediat97.ar_flutter_plugin_engine.Serialization.serializeAnchor
import com.dherediat97.ar_flutter_plugin_engine.Serialization.serializeHitResult
import com.dherediat97.ar_flutter_plugin_engine.Serialization.serializePose
        ...
        object : MethodChannel.MethodCallHandler {
            override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
                ...
                when (call.method) {
                    ...
                    "getAnchorPose" -> {
                        val anchorNode =
                            arSceneView.scene.findByName(call.argument("anchorId")) as AnchorNode?
                        if (anchorNode != null) {
                ...
                when (call.method) {
                    ...
                    "uploadAnchor" -> {
                        ...
                        anchorName?.let {
                            ...
                            if (ttl != null) {
                                cloudAnchorHandler.hostCloudAnchorWithTtl(
                                    anchorName,
                                    anchorNode!!.anchor,
                    ...
                    "downloadAnchor" -> {
                        ...
                        anchorId?.let {
                            cloudAnchorHandler.resolveCloudAnchor(
                                anchorId,
                                cloudAnchorDownloadedListener()
                            )
                        }
                    }
...
//                        onDestroy()
    ...
    private fun initializeARView(call: MethodCall, result: MethodChannel.Result) {
        ...
        if (argShowFeaturePoints ==
            true
        ) { // explicit comparison necessary because of nullable type
    ...
    private inner class cloudAnchorUploadedListener : CloudAnchorHandler.CloudAnchorListener {
        override fun onCloudTaskComplete(anchorName: String?, anchor: Anchor?) {
            ...
            if (cloudState.isError) {
                ...
                sessionManagerChannel.invokeMethod(
                    "onError",
                    listOf("Error uploading anchor, state $cloudState")
                )
                return
            }
    ...
    private inner class cloudAnchorDownloadedListener : CloudAnchorHandler.CloudAnchorListener {
        override fun onCloudTaskComplete(anchorName: String?, anchor: Anchor?) {
            ...
            if (cloudState.isError) {
                ...
                sessionManagerChannel.invokeMethod(
                    "onError",
                    listOf("Error downloading anchor, state $cloudState")
                )
                return
            }
            ...
            anchorManagerChannel.invokeMethod(
                ...
                serializeAnchor(newAnchorNode, anchor),
                object : MethodChannel.Result {
                    ...
                    override fun error(
                        ...
                        sessionManagerChannel.invokeMethod(
                            "onError",
                            listOf("Error while registering downloaded anchor at the AR Flutter plugin: $errorMessage")
                        )
                    }
                    ...
                    override fun notImplemented() {
                        sessionManagerChannel.invokeMethod(
                            "onError",
                            listOf("Error while registering downloaded anchor at the AR Flutter plugin")
                        )
                    }
                })
        }
